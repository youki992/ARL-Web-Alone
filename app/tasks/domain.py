...
class DomainTask(CommonTask):
    ...
    def port_scan(self):
        # 添加port_scan_type参数到扫描选项中
        scan_port_option_with_type = self.scan_port_option.copy()
        scan_port_option_with_type["port_scan_type"] = self.options.get("port_scan_type", "test")
        
        ip_info_list = scan_port(self.domain_info_list, scan_port_option_with_type)
