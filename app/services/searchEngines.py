...
class BaiduSearch(object):
    def __init__(self, keyword=None, page_num=6):
        ...
        self.headers = {"Accept-Language": "zh-cn", "User-Agent":"Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/88.0.4324.104 Safari/537.36"}
...
if __name__ == '__main__':
    for x in baidu_search("a.com", 6):
        print(x)
    # for x in bing_search("a.com", 6):
    #     print(x)
